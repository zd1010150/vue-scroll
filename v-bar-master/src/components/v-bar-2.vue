...
export default {
    ...
    methods: {
        ...
        getBarInternal (axis) {
            ...
            console.log(positionWrapper, sizeWrapper, sizeContainer, sizeBar, 'this is the internalSize')
            return internalSize
        },
        getCoordinates (e, axis) {
            ...
            if (axis === 'X') {
                ...
                sizeContainer = this.container.scrollWidth
                offsetContainer = this.container.elm.offsetLeft - (this.bars.horizontal.size * 1.4)
                ...
                let percentage = (e.clientY - this.dragging.offset + this.bars.vertical.offsetTop)/this.bars.vertical.

            }
            console.log(sizeWrapper, sizeContainer, clientDirection, offsetContainer, sizeContainer, sizeBar)
        ...
        startDrag (e) {
            ...
            console.log(elementOffset, dataDrag)
        ...
        onDrag (e) {
            if (this.dragging.enable) {
                e.preventDefault()
                e.stopPropagation()
                console.log(e.clientX, e.clientY, 'onDrag x y')
                e = e.changedTouches ? e.changedTouches[0] : e
